...
namespace MallSdk.Util
{
    ...
    /// </summary>
        ...
        /// </summary>
        /// <param name="parameters">所有字符型的Mall请求参数</param>
        /// <param name="privateKeyPem">签名密钥</param>
        /// <returns>签名</returns>
        //public static string SignMallRequest(IDictionary<string, string> parameters, string privateKeyPem, string charset, string signType)
        //{
        //    return AlipaySignature.RSASign(parameters, privateKeyPem, charset, signType);
        //}

        //public static string SignMallRequest(IDictionary<string, string> parameters, string privateKeyPem, string charset, bool keyFromFile,string signType)
        //{
