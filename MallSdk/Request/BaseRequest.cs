...
namespace MallSdk
{
    public class BaseRequest
    {
        ...
        public T SetSign<T>(T o, string appId, string secretKey) where T : BaseRequest
        {
            o.AppID = appId;
            o.TS = Getmillis();
            Dictionary<string, string> param;
            param = GetDictionary2(o);
            param.Add("secretkey", secretKey);
            var signs = GenerateSign(param);
            o.Sign = signs;
            return o;
        }
        private static Dictionary<string, string> GetDictionary2(object o)
        {
            ...
            foreach (var p in type.GetProperties())
            {
                ...
                else
                {
                    ...
                    {
                        sortedParams.Add(name, JsonConvert.SerializeObject(value));
                    }
                }
            }
            return sortedParams;
