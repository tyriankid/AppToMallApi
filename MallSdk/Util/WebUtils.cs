...
namespace MallSdk.Util
{
    ...
    public sealed class WebUtils
    {
        ...
        public string DoPost(string url, object o, string charset)
        {
            ...
            string strContent = JsonConvert.SerializeObject(o);
            byte[] postData = Encoding.GetEncoding(charset).GetBytes(strContent);                                       
