...
namespace WeiXin.Lib.Core.Consts
{
    ...
    public class WeiXinConst
    {
        ...
        /// 微信开发者 AppId
        /// </summary>
        public const string AppId = "wx3b1d3e52a378bc9a";


        /// <summary>
        /// 微信开发者 Secret
        /// </summary>
        public const string Secret = "b039d944e8d562f3be86a2dfd7959d26";
        ...
        /// </summary>
        public const string PartnerKey = "asd57491714asd57491714asd5749171";

        /// <summary>
        /// 商户号
        /// </summary>
        public const string PartnerId = "1491450372";
        ...
        /// 证书文件 路径
        /// </summary>
        public const string CertPath = @"C:\inetpub\mgongmu\cert\apiclient_cert.p12";


        /// <summary>
        /// 证书文件密码（默认为商户号）
        /// </summary>
        public const string CertPwd = "1366486402";
        ...
        private const string User_WxGetOpenIdUrl = "https://api.weixin.qq.com/sns/jscode2session?appid={0}&secret={1}&js_code={2}&grant_type=authorization_code";
        /// <summary>
        ...
        public static string WxWeiXin_User_OpenIdUrl { get { return string.Format(User_WxGetOpenIdUrl, "", "", "{0}"); } }
        public static string parkWeiXin_User_OpenIdUrl { get { return string.Format(User_WxGetOpenIdUrl, "wx65cd51f5b9c0cac6", "7459edcde30b55a0bcb6aeeff61a21d0", "{0}"); } }
        public static string AslWeiXin_User_OpenIdUrl { get { return string.Format(User_WxGetOpenIdUrl, "", "", "{0}"); } }
